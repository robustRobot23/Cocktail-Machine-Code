...
from user_lib.rotary import Rotary
from sys import platform
from user_lib.pin_definitions import MENU_SCROLL_A_PIN_NUM, MENU_SCROLL_B_PIN_NUM
...
encoder =  RotaryIRQ(
            MENU_SCROLL_B_PIN_NUM, 
            MENU_SCROLL_A_PIN_NUM,
            min_val=0, 
            max_val=100, #could set as max number of available cocktails?
            incr=1,
            reverse=False, 
